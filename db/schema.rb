...
ActiveRecord::Schema.define(version: 2021_11_23_210812) do
  ...
  add_foreign_key "contacts", "users", column: "doctor_id"
  add_foreign_key "contacts", "users", column: "patient_id"
