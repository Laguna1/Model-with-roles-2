...
ActiveRecord::Schema.define(version: 20_211_208_224_734) do
  ...
  create_table 'appointments', force: :cascade do |t|
    ...
    t.index ['pat_id'], name: 'index_appointments_on_pat_id'
  ...
  add_foreign_key 'appointments', 'users', column: 'pat_id'
